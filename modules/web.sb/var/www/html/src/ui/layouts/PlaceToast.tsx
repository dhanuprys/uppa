                        ...
                        <VistaIframe iframeClassName={is360View ? '' : 'md:rounded-2xl'} className={`size-full ${is360View ? '' : 'rounded-2xl'}`} index={activePlace?.vistaIndex} />
                        {
                            is360View
                                ? <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-[90%] md:w-auto flex flex-col md:flex-row gap-2">
                                    <button onClick={() => set360View(false)} className="md:text-xl highlight-button px-6 py-3 rounded-full mb-4 font-semibold flex gap-2 items-center hover:animate-pulse">
                                        <IoChevronBack />
                                        Kembali
                                    </button>
                                    <button onClick={backToMap} className="md:text-xl border-2 border-blue-50 bg-[rgba(255,255,255,0.8)] px-6 py-3 rounded-full mb-4 font-semibold flex gap-2 items-center hover:animate-pulse">
                                        <IoMapOutline />
                                        Kembali ke peta
                                    </button>
                                </div>
